...
int boatStatus = 0;
int sprgm = 0;							
int ua1 = 1000, ua2 = 900, da1 = 200, da2 = 100;
int lefY = 170, rigY = 120;				

float R = 1, G = 1, B = 1;				//white
float r = 1, g = 1, b = 0;				//yellow
float r1 = 1.0, g1 = 0.5, b1 = 0.0;		//orange
float r2 = 7.0, g2 = 0.0, b2 = 0.0;		//red
float r3 = 0.0, g3 = 0.0, b3 = 1.0;		//blue
float r4 = 0.2, g4 = 0.5, b4 = 0.8;		//light blue
float r5 = 0.0, g5 = 0.7, b5 = 0.0;		//bright green
float r6 = 0.0, g6 = 0.6, b6 = 0.0;		//light green
float r7 = 0.0, g7 = 0.0, b7 = 0.0;		//black
...
int i, s, m, y;
string msg[6] = { "COMPUTER GRAPHICS MINI PROJECT","TOPIC: DEMONSTRATION OF LAND & SEA BREEZE","       DURING DAY AND NIGHT","O A Devasish Kumar 1RN19CS094","PRESS [S] TO START" };
string ins[6] = { "D: DAY","N: NIGHT","B: START BOAT","E: STOP" };
string t, lef = "WARM LAND BREEZE", rig = "COOL SEA BREEZE";		
